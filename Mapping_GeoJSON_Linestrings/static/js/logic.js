...
let torontoData = "https://raw.githubusercontent.com/ssathyanath/Mapping_Earthquakes/main/torontoRoutes.json";
...
d3.json(torontoData).then(function(data) {
  ...
  L.geoJson(data,{
    ...
    onEachFeature: function(feature, layer) {
      console.log(layer)
      layer.bindPopup("<h2> Airline ID: " + feature.properties.airline_id + "</h2><hr><p> Destination: " + feature.properties.dst+ "</p>");
     }
  }).addTo(map);
})
